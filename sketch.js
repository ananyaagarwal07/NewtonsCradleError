...
var rope1, rope2, rope3, rope4, rope5;
	...
	function setup() {
		...
		rope1 = new Rope(bobObject1.body, roofObject.roof, -200,0);
		rope2 = new Rope(bobObject2.body, roofObject.roof, -100,0);
	...
	function keyPressed(){
		if(keyCode === UP_ARROW)
			Matter.Body.applyForce(bobObject3.body, bobObject3.body.position, {x: -150, y: -150});
	}